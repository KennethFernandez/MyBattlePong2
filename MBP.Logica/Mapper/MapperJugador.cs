...
namespace MBP.Logica
{
    class MapperJugador : MapperDecorator
    {
        ...
        public UsuarioModel mapperJugador(Cuenta cuenta, Usuario usuario)
        {
            ...
            {"puntos ganados",estadistica.TotalPuntos.ToString()},{"porcentaje de puntos ganados",CalculoEstadisticas.porcentajeEfectividad(estadistica.TotalPuntos, estadistica.TotalPuntos) + "%"}};
